...
console.log("Data before Phase 2", data); // all 113 courses
console.log("Visual groups", visualGroups); //8 groups, does not include ECO 101
// ------------------- //
// Phase 2: Layout DAG //
// ------------------- //
...
console.log("Layout Nodes", layoutNodes); // 9 groups, has ECO 101
const layoutLinks = [{ source: "ECO 101", target: "ECO 288"},
  { source: "POL 161", target: "POL 366"},
  { source: "POL 161", target: "POL 363"},
  { source: "POL 161", target: "POL 364"},
  { source: "POL 182", target: "POL 422"},
  { source: "POL 182", target: "POL 464"},
];

const links = layoutLinks.map(d => ({...d}));
